  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        <h1 className="sr-only">About Jose Martinez</h1>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-24 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-6 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-md">
              Hello there! I&apos;m Jose Martinez Bardales, a dedicated Software
              Engineer with four years of experience in the tech industry. My
